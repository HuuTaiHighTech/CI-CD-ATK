        ...
        <button
          ...
          className={cn(
            ...
            item.id === tab
              ...
              : 'bg-white lg:bg-transparent lg:hover:bg-secondary-2 lg:hover:text-secondary lg:text-white border border-[#00ADFE]',
            'lg:border-none rounded-full',
